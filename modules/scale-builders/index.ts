...
const ScaleBuilder = function(this: IScaleBuilder, tonic: Note, scaleSchema: any, number_of_octaves: number = 1) {
    this.tonic = tonic
...
} as any as { new(tonic: Note, scaleSchema: any, number_of_octaves?: number): IScaleBuilder }
