...
describe("isNoteHigher", () => {
  ...
  test("unison", () => {
    expect(helpers.isNoteHigher(testsHelpers.C4, testsHelpers.C4)).toBe(false);
  });

  test("octave", () => {
    expect(helpers.isNoteHigher(testsHelpers.C4, testsHelpers.C5)).toBe(true);
    expect(helpers.isNoteHigher(testsHelpers.C5, testsHelpers.C4)).toBe(false);
  });

  test("major second", () => {
    expect(helpers.isNoteHigher(testsHelpers.C4, testsHelpers.D4)).toBe(true);
    expect(helpers.isNoteHigher(testsHelpers.D4, testsHelpers.C4)).toBe(false);
  });

  test("minor third", () => {
    expect(helpers.isNoteHigher(testsHelpers.A4, testsHelpers.C5)).toBe(true);
    expect(helpers.isNoteHigher(testsHelpers.C5, testsHelpers.A4)).toBe(false);
  });
...
describe("isNoteLower", () => {
  it("is false for enharmonies", () => {
    expect(helpers.isNoteLower(testsHelpers.Cb4, testsHelpers.B3)).toBe(false);
  });

  test("unison", () => {
    expect(helpers.isNoteLower(testsHelpers.C4, testsHelpers.C4)).toBe(false);
  });

  test("octave", () => {
    expect(helpers.isNoteLower(testsHelpers.C4, testsHelpers.C5)).toBe(false);
    expect(helpers.isNoteLower(testsHelpers.C5, testsHelpers.C4)).toBe(true);
  });

  test("major second", () => {
    expect(helpers.isNoteLower(testsHelpers.C4, testsHelpers.D4)).toBe(false);
    expect(helpers.isNoteLower(testsHelpers.D4, testsHelpers.C4)).toBe(true);
  });

  test("minor third", () => {
    expect(helpers.isNoteLower(testsHelpers.A4, testsHelpers.C5)).toBe(false);
    expect(helpers.isNoteLower(testsHelpers.C5, testsHelpers.A4)).toBe(true);
  });
