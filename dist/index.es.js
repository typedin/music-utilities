...
function na(a, t) {
  return (
    ((a.name == i.F && t.name == i.E) || (a.name == i.C && q(t))) && N(a, t)
  );
}
function ua(a, t) {
  return (
...
function ea(a, t) {
  return (
    ((a.name == i.E && t.name == i.F) || (q(a) && t.name == i.C)) && N(a, t)
  );
}
function V(a, t) {
  return (
    (t.name == i.C && a.octave == t.octave - 1) ||
    (a.name == i.C && a.octave - 1 == t.octave)
  );
}
function aa(a, t, n = !1) {
  return n && !Q(a, t)
...
function Ea(a, t) {
  return aa(a, t)
    ...
    : a.octave < t.octave
      ...
      : a.octave > t.octave
        ? !1
        : p(a) == p(t) && a.alteration != t.alteration
          ? w(a) < w(t)
          : p(a) < p(t);
}
function za(a, t) {
...
function Ka(a, t) {
  return X(a, { ...t, octave: a[0].octave }) ||
    X(a, { ...t, octave: a[0].octave + 1 })
    ? {
        ...t,
        octave: a[0].octave,
      }
...
function ta(a, t, n, u) {
  const c = a(n, t);
  return (
    c.name == u.name && c.octave == u.octave && c.alteration == u.alteration
  );
}
function xa(a, t, n) {
  let u = t.octave;
...
function L(a, t) {
  ...
  return ((u = Z(a, t)) == null ? void 0 : u.direction) == "down"
