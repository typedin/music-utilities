...
export declare function isNoteHigher(
  reference: Note,
  expectedHigherNote: Note,
): boolean;
export declare function isNoteLower(
  reference: Note,
  expectedLowerNote: Note,
): boolean;
export declare function getNoteFromInterval(
  note: Note,
  interval: number,
): DiatonicNoteEnum;
export declare function getNextNoteOnScale(
  scale: IScaleDegree[],
  note: Note,
): {
...
export declare function getPreviousAlteration(
  needle: AlterationEnum,
): AlterationEnum;
export declare function getNextAlteration(
  needle: AlterationEnum,
): AlterationEnum;
export declare function isInScale(
...
export declare function getFirstPossibleNoteInScale(
  scale: IScaleDegree[],
  note: Note,
): Note;
